            ...
            <el-col :span='5' class="sd-col-6">
             ...
             <el-col :span='5' class="sd-col-6">
              <el-form-item label="到期时间" prop='com_expiretime'>
                  <el-date-picker  v-model="formList.com_expiretime" type="datetime" placeholder="选择到期时间" class="lk-time-box"  value-format="yyyy-MM-dd HH:mm:ss" :picker-options='pickerDateBefore'/>
              </el-form-item>
            </el-col>
  ...
  data() {
    ...
    return {
      ...
      pickerDateBefore: {
        disabledDate: time => {
          let _now = Date.now();
          let beginDateVal = this.formList.com_expiretime;
          if (beginDateVal) {
