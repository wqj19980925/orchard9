            ...
            <el-form-item label="操作时间:" class="lk-time-chose">
              <el-col :span="11">
                <el-form-item prop="cop_createtime_range0">
                  <el-date-picker v-model="formList.cop_createtime_range0"type="datetime"placeholder="开始日期"class="lk-time-box"/>
                </el-form-item>
              </el-col>
              <el-col :span="1">
                <span class="fl">-</span>
              ...
              <el-col :span="11">
                <el-form-item prop="cop_createtime_range1">
                  <el-date-picker v-model="formList.cop_createtime_range1"type="datetime"placeholder="结束日期"class="lk-time-box"/>
                </el-form-item>
              </el-col>
              <el-col :span="1"/>
            </el-form-item>
